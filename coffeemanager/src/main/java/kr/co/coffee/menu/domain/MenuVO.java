...
public class MenuVO extends DTO {
	...
	public MenuVO(String menu_cd, String menu_name, String menu_up, String menu_sp, String mn_reg_dt, String mn_mod_dt,
			String startDate, String endDate, String ing_nm, String menu_amount, String ing_unit, String searchDiv, String searchValue) {
		super();
	...
	public String toString() {
		return "MenuVO [menu_cd=" + menu_cd + ", menu_name=" + menu_name + ", menu_up=" + menu_up + ", menu_sp="
				+ menu_sp + ", mn_reg_dt=" + mn_reg_dt + ", mn_mod_dt=" + mn_mod_dt + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", ing_nm=" + ing_nm + ", menu_amount=" + menu_amount + ", ing_unit="
				+ ing_unit + ", searchDiv=" + searchDiv + ", searchValue=" + searchValue + "]";
	}
