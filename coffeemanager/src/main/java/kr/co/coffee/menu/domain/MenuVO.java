...
public class MenuVO extends DTO {
	...
	public MenuVO(String menu_cd, String menu_name, String menu_up, String menu_sp, String mn_reg_dt, String ing_cd,
	...
	public String toString() {
		return "MenuVO [menu_cd=" + menu_cd + ", menu_name=" + menu_name + ", menu_up=" + menu_up + ", menu_sp="
				+ menu_sp + ", mn_reg_dt=" + mn_reg_dt + ", ing_cd=" + ing_cd + ", ing_nm=" + ing_nm + ", menu_amount="
				+ menu_amount + ", ing_unit=" + ing_unit + ", searchDiv=" + searchDiv + ", startDate=" + startDate
				+ ", endDate=" + endDate + ", searchValue=" + searchValue + "]";
	}
